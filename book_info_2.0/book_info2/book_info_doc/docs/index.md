...
book_info - архитектурное решение для библиотек. Решает проблему учета книг и писателей, читателей и сотрудников. 
## Кому может быть полезно?

Данное архитектурное решение может быть полезно небольшим библиотекам, а также аналогичным организациям в которых присутствует учет предметов, сотрудников и клиентов. 
Архитектура с разделением ответственности: API для обработки данных и оплаты, где API оплаты не имеет доступа к БД, а основной API централизует работу с данными и взаимодействие с хранилищем.
